...
export default function QuizCreatePage() {
  ...
  const handleRemoveAnswer = (questionId: string, answerId: string) => {
    updateQuestion(questionId, (q) => {
      ...
      // Nếu không còn đáp án đúng thì đặt đáp án đầu tiên là đúng
  ...
  const handleSave = async () => {
    ...
    // TODO: call quiz-service API khi backend sẵn sàng
                  ...
                  <div className=\"p-4 md:p-5 space-y-4\">
                    ...
                    <div className=\"space-y-2\">
                      ...
                      <Input
                        ...
                        value={q.tags.join(\", \")}
                        onChange={(e) =>
                          handleQuestionTagInput(q.id, e.target.value)
                        }
                      />
                          ...
                          {q.answers.map((a) => (
                            ...
                            >
                              <input
                                ...
                                checked={a.isCorrect}
                                onChange={() =>
                                  handleSetCorrectAnswer(q.id, a.id)
                                }
