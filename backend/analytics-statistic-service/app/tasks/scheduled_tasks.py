...
async def _send_monthly_summary_async():
    ...
    for teacher_id in teacher_ids:
        await notification_service.send_weekly_report(
            teacher_id=teacher_id, report_data=report_data
        )
...
async def _generate_certificate_async(
    student_id: int, quiz_id: int, certificate_data: dict
):
    ...
    certificate_path = await pdf_service.generate_certificate(
        student_name, certificate_data
    )
