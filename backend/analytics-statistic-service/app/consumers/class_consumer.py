...
class ClassConsumer:
    ...
    async def handle_student_enrolled(self, data: dict):
        ...
        print(f"Processing student enrollment: class_id={class_id}, student_id={student_id}")
    ...
    async def handle_student_removed(self, data: dict):
        ...
        class_id = data.get('class_id')
        student_id = data.get('student_id')
        print(f"Processing student removal: class_id={class_id}, student_id={student_id}")
