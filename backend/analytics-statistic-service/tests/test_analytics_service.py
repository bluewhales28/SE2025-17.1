...
async def test_analyze_student_progress(analytics_service):
    ...
    student_results = [
        {"quiz_id": 1, "score": 70.0, "completed_at": datetime.now() - timedelta(days=10)},
        {"quiz_id": 2, "score": 75.0, "completed_at": datetime.now() - timedelta(days=7)},
        {"quiz_id": 3, "score": 80.0, "completed_at": datetime.now() - timedelta(days=4)},
        {"quiz_id": 4, "score": 85.0, "completed_at": datetime.now() - timedelta(days=1)},
    ]
...
async def test_analyze_question_performance(analytics_service):
    ...
    question_answers = [
        {"is_correct": True, "total_score": 90, "time_spent": 30, "selected_option": "A"},
        {"is_correct": True, "total_score": 85, "time_spent": 25, "selected_option": "A"},
        {"is_correct": False, "total_score": 70, "time_spent": 20, "selected_option": "B"},
        {"is_correct": True, "total_score": 95, "time_spent": 35, "selected_option": "A"},
        {"is_correct": False, "total_score": 60, "time_spent": 15, "selected_option": "C"},
    ]
...
async def test_calculate_score_distribution(analytics_service, sample_quiz_results):
    ...
    distribution = await analytics_service.calculate_score_distribution(sample_quiz_results)
...
async def test_analyze_by_topic(analytics_service):
    ...
    topic_analysis = await analytics_service.analyze_by_topic(quiz_results, questions_metadata)
